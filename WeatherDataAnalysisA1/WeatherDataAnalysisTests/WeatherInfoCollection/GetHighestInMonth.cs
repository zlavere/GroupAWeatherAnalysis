...
namespace WeatherDataAnalysisTests.WeatherInfoCollection
{
    ...
    public class GetHighestInMonth
    {
        ...
        public void TestNoDaysInCollection()
        {
            ...
            Assert.ThrowsException<System.InvalidOperationException>(() => collection.GetHighestInMonth(1));
        }
        ...
        public void TestOneDaysInMonth()
        {
            ...
            var expected = new WeatherDataAnalysis.Model.WeatherInfoCollection("Test1", new List<WeatherInfo> {
                testWeatherInfo
            });
